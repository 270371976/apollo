...
class CarlaCyberBridge(CyberNode):
    ...
    def initialize_bridge(self, carla_world, params, log):
        ...
        ct = cyber_timer.Timer(10, self.synchronous_mode_update, 0)  # 100ms
        ct.start()
        self._registered_actors = []

        self.carla_spawn_objects()
        self.spin()
    ...
    def synchronous_mode_update(self):
        """
        ...
        self.update(frame, world_snapshot.timestamp.elapsed_seconds)
