...
#include <string>
#include <vector>
#include "modules/vtd_bridge/bridge_component/utils/viRDBIcd.h"
...
public:
   ...
   */
  static void* addPackage(RDB_MSG_t*& msg, const double& simTime, const unsigned int& simFrame, unsigned int pkgId, unsigned int noElements, bool extended, size_t trailingData, bool isCustom = false);
   ...
   * @return pointer where to start inserting the data, otherwise 0; message pointer may be altered!
   */
  static void* addCustomPackage(RDB_MSG_t*& msg, const double& simTime, const unsigned int& simFrame, unsigned int pkgId, unsigned int noElements, size_t elementSize);
...
public:
   ...
   */
  void* addPackage(const double& simTime, const unsigned int& simFrame, unsigned int pkgId, unsigned int noElements = 1, bool extended = false, size_t trailingData = 0, bool isCustom = false);
   ...
   * @return pointer where to start inserting the data, otherwise 0
   */
  void* addCustomPackage(const double& simTime, const unsigned int& simFrame, unsigned int pkgId, unsigned int noElements = 1, size_t elementSize = 0);
...
protected:
   ...
   */
  virtual void parseMessageEntryInfo(
